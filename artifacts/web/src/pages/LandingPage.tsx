...
function ProductPreview() {
  ...
  return (
    <motion.div initial={reduceMotion ? false : { opacity: 0, y: 16 }} animate={reduceMotion ? undefined : { opacity: 1, y: 0 }}>
      <div className="relative mx-auto max-w-5xl lg:-translate-x-4 lg:scale-110 xl:scale-125" data-testid="dashboard-hero-preview">
        <Card className="glass-panel glow-primary relative overflow-hidden rounded-xl border-primary/20 bg-card/80 shadow-2xl lg:rotate-1">
          <div className="flex items-center justify-between gap-4 border-b bg-muted/70 px-4 py-3 sm:px-5">
...
function DashboardShowcase({ variant = "main" }: { variant?: string }) {
  ...
  return (
    <div className="relative isolate px-1 sm:px-4 lg:px-8" data-testid={`dashboard-showcase-shell-${variant}`}>
      <Card className="relative z-10 overflow-hidden rounded-xl border-primary/20 bg-sidebar text-sidebar-foreground shadow-2xl lg:-rotate-1" data-testid={`dashboard-showcase-${variant}`}>
        <div className="flex items-center justify-between gap-4 border-b border-sidebar-border bg-sidebar/80 px-4 py-2.5 sm:px-6">
          <div className="flex items-center gap-1.5" aria-label="Browser window controls">
            <span className="h-2.5 w-2.5 rounded-full bg-destructive/70" />
            <span className="h-2.5 w-2.5 rounded-full bg-chart-3/70" />
            <span className="h-2.5 w-2.5 rounded-full bg-primary/70" />
...
function CtaDashboardPreview() {
  return (
    <Card className="glass-panel-dark relative overflow-hidden rounded-xl border-sidebar-border shadow-2xl" data-testid="cta-dashboard-preview">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground" id="top">
      ...
      <header className="glass-panel sticky top-0 z-30 border-b bg-background/70 backdrop-blur-xl" data-testid="navigation-header">
      ...
      <main>
        <section className="relative overflow-hidden border-b bg-gradient-to-br from-sidebar via-chart-4/10 to-primary/15 px-4 py-16 text-sidebar-foreground sm:px-6 lg:px-8 lg:py-24" data-testid="section-hero">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-12 lg:gap-16">
            <motion.div className="max-w-2xl lg:col-span-5" initial={reduceMotion ? false : { opacity: 0, y: 12 }} animate={reduceMotion ? undefined : { opacity: 1, y: 0 }}>
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row"><Button data-testid="button-hero-start-free" size="lg" className="glow-primary" onClick={() => openAuth("login", "hero_start_free")}>Start Free <ArrowRight aria-hidden="true" /></Button><Button data-testid="button-hero-book-demo" size="lg" variant="outline" className="bg-background/10 text-sidebar-foreground shadow-lg hover:bg-background/20" onClick={() => openAuth("login", "hero_book_demo")}>Book Demo <CalendarCheck aria-hidden="true" /></Button></div>

      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center gap-3">
            <CardTitle className="text-base flex items-center gap-2"><School className="h-4 w-4" /> Teacher Accounts</CardTitle>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <p className="text-center text-muted-foreground py-10 text-sm">No teachers found</p>
          ) : (
                    ...
                    <tr key={u.uid} className="border-b border-border/50 hover:bg-accent/30 transition-colors">
                      ...
                      <td className="py-2.5 text-right">
                        <div className="flex items-center justify-end gap-1">
                          ...
                          <Button size="icon" variant="ghost" className="h-7 w-7" onClick={() => handleToggleDisable(u)}>
                            {u.disabled ? <ShieldCheck className="h-3.5 w-3.5 text-green-500" /> : <ShieldOff className="h-3.5 w-3.5 text-amber-500" />}
                          </Button>
                          <Button size="icon" variant="ghost" className="h-7 w-7 text-destructive hover:text-destructive" onClick={() => handleDelete(u)}><Trash2 className="h-3.5 w-3.5" /></Button>
                        </div>
                      </td>
                    </tr>
                  ))}

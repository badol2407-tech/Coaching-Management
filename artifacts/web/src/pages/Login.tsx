...
import { trackLogin, trackLoginFailed, trackRegistered } from "@/lib/analytics";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 p-4">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center space-y-2">
          ...
          <CardTitle className="text-2xl">EduTrack</CardTitle>
          <CardDescription>
            {mode === "login" ? "Sign in to your coaching center" : "Create your account"}
          </CardDescription>
        </CardHeader>
